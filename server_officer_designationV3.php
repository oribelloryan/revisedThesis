  ...
  <body>
    ...
    <div class="container">
      <div class="col-lg-6" style="margin-top:-5%;">
        ...
        $counterAhead = $counter + 1;
        $sectionNow = '#section'.$counter;
        $section = '#section'.$counterAhead;
        echo '<section id='.$sectionNow.' class="form-control" style="width:100%">';
        echo '<span style="margin-left:90px;"></span><a href='.$section.' style="margin-left:350px;">Next</a>';
