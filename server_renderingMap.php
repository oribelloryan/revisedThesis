...
<html lang="en">
  ...
  <body>
    ...
    <center><label id="timeLabel"  style="background-color:#bd593d;color:#ffffff;width:20%;margin-top:1px"></label></center>
    <span id="target"></span>
    ...
    <script type="text/javascript">
      ...
      var breachedSize = 0;
      var breachedArray = [];
      var operationName, boundary, time;
      var markers = [];
      ...
      // https://interceptorpnp.000webhostapp.com/
       ...
       downloadUrl('mobile_checkpoints_target.php/?id='+getUrl(), function(data) {
              ...
              Array.prototype.forEach.call(markers, function(markerElem) {
                ...
                text.textContent = name;
                infowincontent.appendChild(text);
                var policeImage = markerElem.getAttribute('image');

                  var image = {
                    url: 'images/assets/baricade2.png',
             // size: new google.maps.Size(71, 71),
                    anchor: new google.maps.Point(10, 10),
      ...
      downloadUrl('server_tracking.php?id='+getUrl()+'&?name='+operationName, function(data) {
          ...
          setInterval(function(){
              downloadUrl('server_breached.php?id='+getUrl(), function(data) {
                ...
                var image = {
                    url: 'images/assets/barricade_breached.png',
             // size: new google.maps.Size(71, 71),
                    anchor: new google.maps.Point(10, 10),
                    scaledSize: new google.maps.Size(40, 40)
                 };
       ...
       swal({
        ...
        for(i = 0; i < markers.length; i++){
         ...
         function perimeter(loc, size, map){
          ...
          map: map,
          paths: circlePath(loc, size, 360, 'perimeter'),
          center: loc,
          strokeColor: '#FF0000',
          strokeOpacity: 0.35,
          strokeWeight: 2,
          ...
          map: map,
          paths: circlePath(loc, size, 360, 'breached'),
          center: loc,
          strokeColor: '#FF0000',
          strokeOpacity: 0.35,
          strokeWeight: 2,
          ...
          function circlePath(center, radius, points, src){
